...
class Tensor:
    ...
    Args:
        ...
        requires_grad: If the tensor requires_grad (bool)(otherwise gradient doesn't apply to the tensor)
    """
    ...
    def grad_add(self, gradients=None):
        ...
        gradients: Gradients from succession operation. (numpy float/int)
        Returns:
            Tuple: (grad1, grad2)
